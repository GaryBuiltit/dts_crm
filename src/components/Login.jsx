...
import { UserEmailSignin } from "../utilities/auth_signin_reg";
import { useNavigate } from "react-router-dom";
import App from "../App";

function Login(props) {
  const logo = "https://shorturl.at/rEOP5";
  const auth = getAuth();
  ...
  function handleForm(e) {
    e.preventDefault();
    // const user = UserEmailSignin(
    //   auth,
    //   e.target.email.value,
    //   e.target.password.value
    // );

    // if (user != null) <Navigate to="../App" />;
    navigate("/dashboard");
  }
      ...
      <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <button className="btn w-full">
            <img src="https://shorturl.at/kopK3" className=" size-10" /> Sign in
            with Google
          </button>
